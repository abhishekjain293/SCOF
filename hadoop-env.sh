...
# The maximum amount of heap to use, in MB. Default is 8M.
#export HADOOP_HEAPSIZE=10M 
#export HADOOP_NAMENODE_INIT_HEAPSIZE="-Xmx8M"
export HADOPP_HEAPSIZE=8M
export HADOOP_NAMENODE_INIT_HEAPSIZE="-8M"
